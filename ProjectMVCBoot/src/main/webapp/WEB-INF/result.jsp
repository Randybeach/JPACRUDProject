...
<a class="btn btn-primary" href="delete.do?id=${passenger.id}" role="button">Delete</a> <a class="btn btn-primary" href="updateView.do?id=${passenger.id}" role="button">Update</a>

</c:if>
<c:forEach var="passengers" items="${passengers}">
<ul>
<li><a href="getPassenger.do?id=${passengers.id}" >${passengers.firstName} ${passengers.lastName}</a>
</ul>
</c:forEach>
